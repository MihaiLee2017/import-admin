  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="codeId">
        ...
        <el-input ref="codeId" v-model="loginForm.codeId" placeholder="codeId" name="codeId" type="text" tabindex="1" auto-complete="on" />
      </el-form-item>
      ...
      <div class="tips">
        <span style="margin-right:20px;">codeId: 123456</span>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        codeId: [
          { required: true, trigger: 'blur', validator: validateCodeId }
        ],
        password: [
